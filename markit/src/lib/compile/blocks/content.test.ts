...
describe("compile > blocks > content", () => {
  ...
  it("handles dashes", () => {
    // plain text
    assertEquals(content("{-}", "text"), "&ndash;");
    assertEquals(content("{--}", "text"), "&mdash;");

    // html
    assertEquals(content("{-}", "html"), "<p>&ndash;</p>");
    assertEquals(content("{--}", "html"), "<p>&mdash;</p>");
  });
  ...
  it("handles foreign text", () => {
    ...
    assertEquals(
      ...
      '<p><em class="foreign">foreign text</em></p>',
    );
  });
  ...
  it("handles greek text", () => {
    ...
    assertEquals(
      ...
      '<p><em class="foreign">γρεεκ τεχτ</em></p>',
    );
  });
  ...
  it("handles greek text nested inside foreign text", () => {
    ...
    assertEquals(
      ...
      '<p><em class="foreign">foreign text with γρεεκ τεχτ inside</em></p>',
    );
  });
  ...
  it("handles margin comments", () => {
    ...
    assertEquals(
      ...
      '<p><span class="aside">margin comment</span></p>',
    );
  });
  ...
  it("parses nested tags", () => {
    ...
    assertEquals(
      ...
      '<h1>Heading 1</h1><h2>Heading 2</h2><p>Paragraph.<br />This <em>sentence has <span class="aside">some <strong>nested</strong></span> tags</em>.</p>',
    );
  });
});
